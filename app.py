...
if sim_season == "2026 (Current)":
    ...
    st.info("⚠️ 2026 rookies (ANT, HAD, LIN, BOR, COL) show 0% until model is retrained with 2024-2025 data.")
else:
    active_grid = default_grid_2023
    st.success("✅ All 2023 drivers are fully supported by the model.")
